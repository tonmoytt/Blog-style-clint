    ...
    return (
        <div>
           <div className='mb-6 bg-orange-100 '>
            ...
            <hr className='w-full mb-2 text-red-600' />
            <div className="hero min-h-screen m-6" style={{ backgroundImage: 'url(https://i.ibb.co/t2q0qmD/2b8d775b57ef8a1c2ab207923d80aabf.jpg)' }}>
                ...
                <div className="mr-10 md:mr-72 lg:mr-90 hero-content text-neutral-content">
                    <div className="mr-10 md:mr-40 lg:mr-96 px-6 py-6 ">
                        ...
                        <h1 className="text-2xl md:text-4xl lg:text-4xl font-serif font-bold mb-10"> <span className="text-teal-300 font-extrabold text-7xl "> Stay curious. </span> 
                        </h1>
